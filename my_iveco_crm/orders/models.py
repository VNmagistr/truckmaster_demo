...
class Work(models.Model):
    """
    Конкретна робота з прайс-листа з ціною за годину.
    """
...
class ServiceOrder(models.Model):
    ...
    order_number = models.CharField(
        ...
        blank=True,
        null=True,
        verbose_name="Номер наряду-замовлення"
    )
    ...
    def save(self, *args, **kwargs):
        if not self.order_number:
            # Знаходимо максимальний числовий order_number в базі даних
            max_number = ServiceOrder.objects.aggregate(
            ...
            if max_number and max_number.isdigit():
                ...
                # Якщо номерів ще немає, або вони не числові, починаємо з 1001
                next_number = 1001
